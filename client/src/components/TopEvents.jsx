...
let dates2 = [
  ...
  { day: 5, month: "february",image:"https://t4.ftcdn.net/jpg/04/19/26/97/360_F_419269782_9LsP3TQndMVnZ2j3ZhTPhMjaqQpFAth9.jpg"} ,
  { day: 12, month: "march",image:"https://i0.wp.com/softwarespace.ie/wp-content/uploads/2022/08/software-development-project-ideas.png?fit=600%2C399&ssl=1"},
  { day: 20, month: "april",image:"https://www.shutterstock.com/shutterstock/photos/1932042689/display_1500/stock-photo-businessman-using-mobile-smart-phone-business-global-internet-connection-application-technology-1932042689.jpg"},
  { day: 25, month: "may",image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH2VvZKHRJL5R4gPqtK9kwzxGDMMlXmX6CiA&s"},
  { day: 30, month: "june",image:"https://www.shutterstock.com/shutterstock/photos/1932042689/display_1500/stock-photo-businessman-using-mobile-smart-phone-business-global-internet-connection-application-technology-1932042689.jpg"},
...
function EventCard({ date }) {
  return (
    <div className="relative flex justify-center items-center w-52  h-32 2xl:w-64  2xl:h-40 bg-[#ECF7FE] rounded-lg font-bold text-white drop-shadow-xl shadow-slate-700/3  border border-black"
